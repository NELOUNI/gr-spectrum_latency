...
# Generated: Fri Jan 22 10:56:10 2016
##################################################
...
class MSOD_SSLSensor_N210(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.msod_sensor_sslsocket_sink_0 = msod_sensor.sslsocket_sink(num_ch, dest_host, "/raid/nae/pybombs/src/gr-msod_latency/examples/sensor.loc", "/raid/nae/pybombs/src/gr-msod_latency/examples/sensor.sys", "F37258", "NaN", center_freq, ActualBW, meas_interval, 0, samp_rate, False)
